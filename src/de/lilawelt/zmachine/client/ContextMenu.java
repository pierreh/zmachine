	...
	private void createPopupMenu() {
		...
		Command contact = new Command() {
			public void execute() {
				...
				p.hide();
				HTML text = new HTML("Contact:<br><br>Bernhard Amann<br>Seehang 2a<br>82335 Berg<br><br>amannb@arcor.de<br><a href='http://z-machine.lilawelt.de' target='_blank'>Z-Machine.lilawelt.de</a>");
				contact.add(text);
				contact.center();
				contact.show();
			}
